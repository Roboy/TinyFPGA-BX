...
const int  CS_AT25SF081   = 53;             // Flash Memory Chip Select - Active Low
const int  holdPin        = 48;              // HOLD Pin - Active Low
...
const int  programButton               = 2;      // LATCH button used to set resolution
...
void loop()
{
  ...
  long some24bitLocation = 0x000005;   // Starting address we'll use to R/W
  byte someData          = 0xCC;       // Some data to write to memory
